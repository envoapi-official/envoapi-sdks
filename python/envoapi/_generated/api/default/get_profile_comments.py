...
from ...models.profile_comments_success import ProfileCommentsSuccess
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProfileCommentsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get a Profile's recent comments.
    ...
    Returns:
        Response[InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | ProfileCommentsSuccess | ProfilePostsInvalidRequestResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse]
    """
