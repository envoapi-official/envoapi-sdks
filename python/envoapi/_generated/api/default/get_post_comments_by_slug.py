...
from ...models.get_post_comments_by_slug_sort_order import GetPostCommentsBySlugSortOrder
...
from ...models.linked_in_v2_post_comments_success import LinkedInV2PostCommentsSuccess
...
def _get_kwargs(
    *,
    slug: str,
    sort_order: GetPostCommentsBySlugSortOrder | Unset = GetPostCommentsBySlugSortOrder.CHRONOLOGICAL,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LinkedInV2PostCommentsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get a Post's comments by slug

    Args:
        slug (str):
        sort_order (GetPostCommentsBySlugSortOrder | Unset):  Default:
            GetPostCommentsBySlugSortOrder.CHRONOLOGICAL.
    ...
    Returns:
        Response[InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2PostCommentsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2PostCommentsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse
    """
