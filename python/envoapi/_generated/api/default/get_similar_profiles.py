...
from ...models.similar_profiles_success import SimilarProfilesSuccess
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SimilarProfilesSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get profiles similar to a Profile.
