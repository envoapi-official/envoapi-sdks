...
from ...models.job_search_success import JobSearchSuccess
...
from ...models.search_jobs_experience import SearchJobsExperience
from ...models.search_jobs_sort import SearchJobsSort
from ...models.search_jobs_time_posted import SearchJobsTimePosted
...
def _get_kwargs(
    *,
    ...
    experience: SearchJobsExperience | Unset = UNSET,
    sort: SearchJobsSort | Unset = SearchJobsSort.RELEVANCE,
    time_posted: SearchJobsTimePosted | Unset = SearchJobsTimePosted.ANY,
) -> dict[str, Any]:
    ...
    json_experience: str | Unset = UNSET
    if not isinstance(experience, Unset):
        json_experience = experience.value
    ...
    json_time_posted: str | Unset = UNSET
    if not isinstance(time_posted, Unset):
        json_time_posted = time_posted.value

    params["timePosted"] = json_time_posted
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = JobSearchSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Search LinkedIn job cards.

    Args:
        keywords (str):
        start (int | Unset):  Default: 0.
        location (str | Unset): A location name or an ID from [Location
            search](../searchlocationsbykeyword/) (`data.locations[].id`).
        company_slug (str | Unset):
        experience (SearchJobsExperience | Unset):
        sort (SearchJobsSort | Unset):  Default: SearchJobsSort.RELEVANCE.
        time_posted (SearchJobsTimePosted | Unset):  Default: SearchJobsTimePosted.ANY.
    ...
    Returns:
        Response[InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | JobSearchSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | JobSearchSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse
    """
