...
from ...models.get_post_comments_by_url_sort_order import GetPostCommentsByUrlSortOrder
...
def _get_kwargs(
    *,
    url_query: str,
    sort_order: GetPostCommentsByUrlSortOrder | Unset = GetPostCommentsByUrlSortOrder.CHRONOLOGICAL,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Get a Post's comments by URL

    Args:
        url_query (str):
        sort_order (GetPostCommentsByUrlSortOrder | Unset):  Default:
            GetPostCommentsByUrlSortOrder.CHRONOLOGICAL.
