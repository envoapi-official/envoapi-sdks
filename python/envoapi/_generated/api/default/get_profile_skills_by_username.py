...
from ...models.profile_skills_success import ProfileSkillsSuccess
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/profiles/skills/by-username",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProfileSkillsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get Profile Skills by username
