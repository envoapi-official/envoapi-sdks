...
from ...models.profile_courses_success import ProfileCoursesSuccess
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/profiles/courses/by-username",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProfileCoursesSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get Profile Courses by username
