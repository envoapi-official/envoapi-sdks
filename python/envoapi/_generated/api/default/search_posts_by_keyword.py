...
from ...models.linked_in_v2_search_posts_success import LinkedInV2SearchPostsSuccess
...
from ...models.search_posts_by_keyword_content_type import SearchPostsByKeywordContentType
from ...models.search_posts_by_keyword_posted_within import SearchPostsByKeywordPostedWithin
from ...models.search_posts_by_keyword_sort import SearchPostsByKeywordSort
...
def _get_kwargs(
    *,
    keywords: str,
    offset: int | Unset = 0,
    sort: SearchPostsByKeywordSort | Unset = SearchPostsByKeywordSort.RELEVANCE,
    posted_within: SearchPostsByKeywordPostedWithin | Unset = UNSET,
    content_type: SearchPostsByKeywordContentType | Unset = UNSET,
) -> dict[str, Any]:
    ...
    json_posted_within: str | Unset = UNSET
    if not isinstance(posted_within, Unset):
        json_posted_within = posted_within.value

    params["postedWithin"] = json_posted_within
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LinkedInV2SearchPostsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        sort (SearchPostsByKeywordSort | Unset):  Default: SearchPostsByKeywordSort.RELEVANCE.
        posted_within (SearchPostsByKeywordPostedWithin | Unset):
        content_type (SearchPostsByKeywordContentType | Unset):
    ...
    Returns:
        Response[InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2SearchPostsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse]
    """
...
def sync(
    *,
    ...
    Returns:
        InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2SearchPostsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse
    """
