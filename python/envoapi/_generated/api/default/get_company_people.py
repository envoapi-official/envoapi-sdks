...
from ...models.company_people_success import CompanyPeopleSuccess
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CompanyPeopleSuccess.from_dict(response.json())
