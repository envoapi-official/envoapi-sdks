...
from ...models.company_jobs_success import CompanyJobsSuccess
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CompanyJobsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get a Company's recent jobs.

    Args:
        slug (str):
        start (int | Unset): Zero-based offset into the first 1,000 matching jobs. Follow
            meta.paging.nextStart for subsequent pages. Default: 0.
