...
from ...models.get_post_reactions_by_url_reaction_type import GetPostReactionsByUrlReactionType
...
def _get_kwargs(
    *,
    url_query: str,
    reaction_type: GetPostReactionsByUrlReactionType,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Get normalized Post reactions by URL
