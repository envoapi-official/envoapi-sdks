...
from ...models.profile_certifications_success import ProfileCertificationsSuccess
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/profiles/certifications/by-username",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProfileCertificationsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get Profile Certifications by username
