...
from ...models.get_company_products_state import GetCompanyProductsState
...
from ...models.linked_in_v2_company_products_success import LinkedInV2CompanyProductsSuccess
...
def _get_kwargs(
    *,
    slug: str,
    state: GetCompanyProductsState | Unset = GetCompanyProductsState.PUBLISHED,
    start: int | Unset = 0,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LinkedInV2CompanyProductsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        slug (str):
        state (GetCompanyProductsState | Unset):  Default: GetCompanyProductsState.PUBLISHED.
...
def sync(
    *,
    ...
    Returns:
        InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2CompanyProductsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse
    """
