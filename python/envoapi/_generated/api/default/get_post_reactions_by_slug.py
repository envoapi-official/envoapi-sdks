...
from ...models.get_post_reactions_by_slug_reaction_type import GetPostReactionsBySlugReactionType
...
from ...models.linked_in_v2_post_reactions_success import LinkedInV2PostReactionsSuccess
...
def _get_kwargs(
    *,
    slug: str,
    reaction_type: GetPostReactionsBySlugReactionType,
) -> dict[str, Any]:
    ...
    json_reaction_type = reaction_type.value
    params["reactionType"] = json_reaction_type

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/posts/reactions/by-slug",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = LinkedInV2PostReactionsSuccess.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get normalized Post reactions by slug
...
def sync(
    *,
    ...
    Returns:
        InsufficientCreditsErrorResponse | InternalServerErrorResponse | InvalidApiKeyErrorResponse | InvalidRequestErrorResponse | LinkedInV2PostReactionsSuccess | LookupForbiddenErrorResponse | MethodNotAllowedErrorResponse | NotAcceptableErrorResponse | RateLimitExceededErrorResponse | ResourceNotFoundErrorResponse | ServiceUnavailableErrorResponse | UnsupportedMediaTypeErrorResponse | UpstreamErrorResponse | UpstreamTimeoutErrorResponse
    """
