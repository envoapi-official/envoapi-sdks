...
T = TypeVar("T", bound="SingletonSectionMetaType0Type0")


@_attrs_define
class SingletonSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        singleton_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return singleton_section_meta_type_0_type_0
