...
T = TypeVar("T", bound="CompanyDomainSearchSuccessMeta")


@_attrs_define
class CompanyDomainSearchSuccessMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_domain_search_success_meta = cls(
            paging=paging,
            credit_cost=credit_cost,
        )

        return company_domain_search_success_meta
