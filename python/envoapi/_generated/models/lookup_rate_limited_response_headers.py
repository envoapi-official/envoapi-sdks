...
T = TypeVar("T", bound="LookupRateLimitedResponseHeaders")


@_attrs_define
class LookupRateLimitedResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retry_after = d.pop("Retry-After")

        lookup_rate_limited_response_headers = cls(
            date=date,
        ...
        return lookup_rate_limited_response_headers
