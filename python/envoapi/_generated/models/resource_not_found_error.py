...
T = TypeVar("T", bound="ResourceNotFoundError")
...
class ResourceNotFoundError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["resource_not_found"], d.pop("code"))
        if code != "resource_not_found":
            raise ValueError(f"code must match const 'resource_not_found', got '{code}'")
