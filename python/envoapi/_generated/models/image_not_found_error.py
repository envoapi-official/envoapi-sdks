...
T = TypeVar("T", bound="ImageNotFoundError")
...
class ImageNotFoundError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["image_not_found"], d.pop("code"))
        if code != "image_not_found":
            raise ValueError(f"code must match const 'image_not_found', got '{code}'")
