...
T = TypeVar("T", bound="CompleteSectionMetaType1")


@_attrs_define
class CompleteSectionMetaType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_returned_count(data: object) -> int | None:
            if data is None:
                return data
        ...
        complete_section_meta_type_1 = cls(
            status=status,
        ...
        return complete_section_meta_type_1
