...
T = TypeVar("T", bound="SchoolKeywordSearchSuccessMeta")


@_attrs_define
class SchoolKeywordSearchSuccessMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        school_keyword_search_success_meta = cls(
            paging=paging,
            credit_cost=credit_cost,
        )

        return school_keyword_search_success_meta
