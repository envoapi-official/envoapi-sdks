...
T = TypeVar("T", bound="RouteNotFoundError")
...
class RouteNotFoundError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["route_not_found"], d.pop("code"))
        if code != "route_not_found":
            raise ValueError(f"code must match const 'route_not_found', got '{code}'")
