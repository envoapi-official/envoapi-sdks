...
T = TypeVar("T", bound="CertificationSectionMetaType1")


@_attrs_define
class CertificationSectionMetaType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certification_section_meta_type_1 = cls(
            status=status,
        ...
        return certification_section_meta_type_1
