...
T = TypeVar("T", bound="CourseSectionMetaType0Type0")


@_attrs_define
class CourseSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        course_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return course_section_meta_type_0_type_0
