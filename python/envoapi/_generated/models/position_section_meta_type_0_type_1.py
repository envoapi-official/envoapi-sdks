...
T = TypeVar("T", bound="PositionSectionMetaType0Type1")


@_attrs_define
class PositionSectionMetaType0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        position_section_meta_type_0_type_1 = cls(
            status=status,
        ...
        return position_section_meta_type_0_type_1
