...
T = TypeVar("T", bound="ProductSectionMetaType0Type0")


@_attrs_define
class ProductSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return product_section_meta_type_0_type_0
