...
T = TypeVar("T", bound="ResponseTooLargeError")
...
class ResponseTooLargeError:
    """
    Attributes:
        code (Literal['response_too_large']):
        message (str):
        retryable (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["response_too_large"], d.pop("code"))
        if code != "response_too_large":
            raise ValueError(f"code must match const 'response_too_large', got '{code}'")
