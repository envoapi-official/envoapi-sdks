...
T = TypeVar("T", bound="CertificationSectionMetaType0Type0")


@_attrs_define
class CertificationSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certification_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return certification_section_meta_type_0_type_0
