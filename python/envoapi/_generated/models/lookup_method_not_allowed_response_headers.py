...
T = TypeVar("T", bound="LookupMethodNotAllowedResponseHeaders")


@_attrs_define
class LookupMethodNotAllowedResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allow = cast(Literal["GET"], d.pop("Allow"))
        if allow != "GET":
            raise ValueError(f"Allow must match const 'GET', got '{allow}'")

        lookup_method_not_allowed_response_headers = cls(
            date=date,
        ...
        return lookup_method_not_allowed_response_headers
