...
T = TypeVar("T", bound="LinkedInV2ProfileTopCardSuccessMeta")


@_attrs_define
class LinkedInV2ProfileTopCardSuccessMeta:
    """
    Attributes:
        credit_cost (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_profile_top_card_success_meta = cls(
            credit_cost=credit_cost,
            paging=paging,
        )

        return linked_in_v2_profile_top_card_success_meta
