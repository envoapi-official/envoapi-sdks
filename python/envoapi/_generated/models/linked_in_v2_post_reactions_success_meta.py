...
T = TypeVar("T", bound="LinkedInV2PostReactionsSuccessMeta")


@_attrs_define
class LinkedInV2PostReactionsSuccessMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_post_reactions_success_meta = cls(
            paging=paging,
            credit_cost=credit_cost,
        )

        return linked_in_v2_post_reactions_success_meta
