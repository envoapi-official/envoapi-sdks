...
T = TypeVar("T", bound="NonRetryableServiceUnavailableError")


@_attrs_define
class NonRetryableServiceUnavailableError:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        non_retryable_service_unavailable_error = cls(
            code=code,
            message=message,
            retryable=retryable,
            details=details,
        ...
        return non_retryable_service_unavailable_error
