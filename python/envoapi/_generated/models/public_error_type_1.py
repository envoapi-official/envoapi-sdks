...
from ..models.public_error_type_1_code import PublicErrorType1Code

if TYPE_CHECKING:
    from ..models.validation_detail import ValidationDetail


T = TypeVar("T", bound="PublicErrorType1")


@_attrs_define
class PublicErrorType1:
    """
    Attributes:
        code (PublicErrorType1Code):
        message (str):
        retryable (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = PublicErrorType1Code(d.pop("code"))
