...
T = TypeVar("T", bound="LinkedInV2CompanyPeopleGroupingsSuccessMeta")


@_attrs_define
class LinkedInV2CompanyPeopleGroupingsSuccessMeta:
    """
    Attributes:
        credit_cost (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_company_people_groupings_success_meta = cls(
            credit_cost=credit_cost,
            paging=paging,
        )

        return linked_in_v2_company_people_groupings_success_meta
