...
T = TypeVar("T", bound="LookupSettlementUncertainWithoutKeyResponseHeaders")


@_attrs_define
class LookupSettlementUncertainWithoutKeyResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lookup_settlement_uncertain_without_key_response_headers = cls(
            date=date,
        ...
        return lookup_settlement_uncertain_without_key_response_headers
