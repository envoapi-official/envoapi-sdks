...
T = TypeVar("T", bound="LinkedInV2ProfilePostsQuery")


@_attrs_define
class LinkedInV2ProfilePostsQuery:
    """
    Attributes:
        username (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_profile_posts_query = cls(
            username=username,
            cursor=cursor,
        )

        return linked_in_v2_profile_posts_query
