...
T = TypeVar("T", bound="OrganizationSectionMetaType0Type0")


@_attrs_define
class OrganizationSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return organization_section_meta_type_0_type_0
