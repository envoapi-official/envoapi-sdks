...
T = TypeVar("T", bound="ContactSectionMetaType0Type0")


@_attrs_define
class ContactSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contact_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return contact_section_meta_type_0_type_0
