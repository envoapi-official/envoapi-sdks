...
T = TypeVar("T", bound="AccountSuspendedError")
...
class AccountSuspendedError:
    """
    Attributes:
        code (Literal['account_suspended']):
        message (str):
        retryable (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["account_suspended"], d.pop("code"))
        if code != "account_suspended":
            raise ValueError(f"code must match const 'account_suspended', got '{code}'")
        ...
        return account_suspended_error
