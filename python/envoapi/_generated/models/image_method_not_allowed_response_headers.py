...
T = TypeVar("T", bound="ImageMethodNotAllowedResponseHeaders")


@_attrs_define
class ImageMethodNotAllowedResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        image_method_not_allowed_response_headers = cls(
            date=date,
        ...
        return image_method_not_allowed_response_headers
