...
T = TypeVar("T", bound="VolunteerExperienceSectionMetaType1")


@_attrs_define
class VolunteerExperienceSectionMetaType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        volunteer_experience_section_meta_type_1 = cls(
            status=status,
        ...
        return volunteer_experience_section_meta_type_1
