...
T = TypeVar("T", bound="RetryableServiceUnavailableError")


@_attrs_define
class RetryableServiceUnavailableError:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retryable_service_unavailable_error = cls(
            code=code,
            message=message,
            retryable=retryable,
            details=details,
        ...
        return retryable_service_unavailable_error
