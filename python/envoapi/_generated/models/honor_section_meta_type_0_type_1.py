...
T = TypeVar("T", bound="HonorSectionMetaType0Type1")


@_attrs_define
class HonorSectionMetaType0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        honor_section_meta_type_0_type_1 = cls(
            status=status,
        ...
        return honor_section_meta_type_0_type_1
