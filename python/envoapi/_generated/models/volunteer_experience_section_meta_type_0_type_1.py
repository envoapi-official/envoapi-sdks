...
T = TypeVar("T", bound="VolunteerExperienceSectionMetaType0Type1")


@_attrs_define
class VolunteerExperienceSectionMetaType0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        volunteer_experience_section_meta_type_0_type_1 = cls(
            status=status,
        ...
        return volunteer_experience_section_meta_type_0_type_1
