...
T = TypeVar("T", bound="RequiredCoreSectionMetaType1")


@_attrs_define
class RequiredCoreSectionMetaType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        required_core_section_meta_type_1 = cls(
            status=status,
        ...
        return required_core_section_meta_type_1
