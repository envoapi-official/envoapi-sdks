...
T = TypeVar("T", bound="LookupServiceUnavailableSettledResponseHeaders")


@_attrs_define
class LookupServiceUnavailableSettledResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lookup_service_unavailable_settled_response_headers = cls(
            date=date,
        ...
        return lookup_service_unavailable_settled_response_headers
