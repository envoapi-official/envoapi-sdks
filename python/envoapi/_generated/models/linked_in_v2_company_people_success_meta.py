...
T = TypeVar("T", bound="LinkedInV2CompanyPeopleSuccessMeta")


@_attrs_define
class LinkedInV2CompanyPeopleSuccessMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_company_people_success_meta = cls(
            paging=paging,
            credit_cost=credit_cost,
        )

        return linked_in_v2_company_people_success_meta
