...
T = TypeVar("T", bound="CertificationItemType1")


@_attrs_define
class CertificationItemType1:
    """
    Attributes:
        expires_on (None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        certification_item_type_1 = cls(
            expires_on=expires_on,
            does_not_expire=does_not_expire,
        )

        certification_item_type_1.additional_properties = d
        return certification_item_type_1
