...
T = TypeVar("T", bound="LookupServiceUnavailablePostRateResponseHeaders")


@_attrs_define
class LookupServiceUnavailablePostRateResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lookup_service_unavailable_post_rate_response_headers = cls(
            date=date,
        ...
        return lookup_service_unavailable_post_rate_response_headers
