...
T = TypeVar("T", bound="PeopleKeywordSearchSuccessMeta")


@_attrs_define
class PeopleKeywordSearchSuccessMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        people_keyword_search_success_meta = cls(
            paging=paging,
            credit_cost=credit_cost,
        )

        return people_keyword_search_success_meta
