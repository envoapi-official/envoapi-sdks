...
T = TypeVar("T", bound="CompanyInterestSectionMetaType0Type0Type1")


@_attrs_define
class CompanyInterestSectionMetaType0Type0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_interest_section_meta_type_0_type_0_type_1 = cls(
            status=status,
        ...
        return company_interest_section_meta_type_0_type_0_type_1
