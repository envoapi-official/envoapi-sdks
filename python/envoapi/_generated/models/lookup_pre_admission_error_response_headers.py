...
T = TypeVar("T", bound="LookupPreAdmissionErrorResponseHeaders")


@_attrs_define
class LookupPreAdmissionErrorResponseHeaders:
    """
    Attributes:
        date (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lookup_pre_admission_error_response_headers = cls(
            date=date,
        ...
        return lookup_pre_admission_error_response_headers
