...
T = TypeVar("T", bound="OrganizationSectionMetaType1")


@_attrs_define
class OrganizationSectionMetaType1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        organization_section_meta_type_1 = cls(
            status=status,
        ...
        return organization_section_meta_type_1
