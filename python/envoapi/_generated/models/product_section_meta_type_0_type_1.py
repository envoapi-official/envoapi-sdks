...
T = TypeVar("T", bound="ProductSectionMetaType0Type1")


@_attrs_define
class ProductSectionMetaType0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_section_meta_type_0_type_1 = cls(
            status=status,
        ...
        return product_section_meta_type_0_type_1
