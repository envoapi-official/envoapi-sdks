...
T = TypeVar("T", bound="InvalidApiKeyError")
...
class InvalidApiKeyError:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["invalid_api_key"], d.pop("code"))
        if code != "invalid_api_key":
            raise ValueError(f"code must match const 'invalid_api_key', got '{code}'")
