...
T = TypeVar("T", bound="LanguageSectionMetaType0Type0")


@_attrs_define
class LanguageSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        language_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return language_section_meta_type_0_type_0
