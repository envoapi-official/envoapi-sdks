...
T = TypeVar("T", bound="CourseSectionMetaType0Type1")


@_attrs_define
class CourseSectionMetaType0Type1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        course_section_meta_type_0_type_1 = cls(
            status=status,
        ...
        return course_section_meta_type_0_type_1
