...
T = TypeVar("T", bound="LinkedInV2ProfileReactionsQuery")


@_attrs_define
class LinkedInV2ProfileReactionsQuery:
    """
    Attributes:
        username (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linked_in_v2_profile_reactions_query = cls(
            username=username,
            cursor=cursor,
        )

        return linked_in_v2_profile_reactions_query
