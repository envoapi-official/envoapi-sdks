...
T = TypeVar("T", bound="InsufficientCreditsError")
...
class InsufficientCreditsError:
    """
    Attributes:
        code (Literal['insufficient_credits']):
        message (str):
        retryable (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        code = cast(Literal["insufficient_credits"], d.pop("code"))
        if code != "insufficient_credits":
            raise ValueError(f"code must match const 'insufficient_credits', got '{code}'")
        ...
        insufficient_credits_error = cls(
            code=code,
            message=message,
            retryable=retryable,
            details=details,
