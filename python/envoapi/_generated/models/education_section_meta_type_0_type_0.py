...
T = TypeVar("T", bound="EducationSectionMetaType0Type0")


@_attrs_define
class EducationSectionMetaType0Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        education_section_meta_type_0_type_0 = cls(
            status=status,
        ...
        return education_section_meta_type_0_type_0
